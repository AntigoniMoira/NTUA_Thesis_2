...
import 'package:med_reminder/screens/doctors/doctor_tile.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if(doctors.length != 0) {
      ...
      return Container(
        ...
        child: Text('Αποθηκεύστε τους θεράποντες ιατρούς σας ώστε να μπορείτε να βρίσκετε τα στοιχεία τους εύκολα όταν τα χρειάζεστε.',
