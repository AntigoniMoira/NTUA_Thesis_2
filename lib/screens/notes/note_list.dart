...
import 'package:med_reminder/screens/notes/note_tile.dart';
...
class _NoteListState extends State<NoteList> {
  ...
  Widget build(BuildContext context) {
    ...
    final notes = Provider.of<List<NoteData>>(context) ?? [];
    ...
    if(notes.length != 0) {
      ...
      return Container(
        ...
        child: Text('Αποθηκεύστε σημειώσεις με όσα θέλετε να αναφέρετε στον γιατρό σας στην επόμενη επίσκεψη.',
